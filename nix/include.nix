...
#   exactly this SDK's own three headers -- logos_qt_lp_bridge.h,
#   logos_qt_wire.h, logos_qt_host_core.h -- and stays that way as long as cpp/
#   holds only what this SDK owns. (logos_ui_plugin_context.h was a fourth until
#   logos-view-module took sole ownership of it.)
{ pkgs, common, src }:
